...
method which allows pruning each lexical unit \av[in the resulting]{from the result} \av{\emph{"from the result set" jsem pochopila jako ze se cela LU zahodi}} set so that it contains only the properties/attributes a user is interested in. Another method is provided to compute various histograms.
