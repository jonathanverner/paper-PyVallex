...
cross-lexicon link validation into the old pipeline seems impossible.
...
representation of this data in a \emph{SQLite} database for safe concurrent access.
The user can open an editor view (see \autoref{fig:ui-editing}) and do some simple edits. When the editor
...
The first author was also supported by Charles University Research Centre program No. UNCE/SCI/022 and by the Progres grant Q14. Krize racionality a modernı́ myšlenı́.
